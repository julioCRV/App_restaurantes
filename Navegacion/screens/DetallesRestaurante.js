        ...
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <View style={styles.infoItem}>
                    <Icon name="directions" size={24} color="#000" />
                    <Text style={styles.infoText}> Dirección: {restaurantData.street}</Text>
                </View>
            </View>

            <View style={styles.infoContainer}>
                <View style={styles.infoItem}>
                    <Icon name="query-builder" size={24} color="#000" />
                    <Text style={styles.infoText}> Horario: {restaurantData.opening_time} - {closing_time}
                    </Text>
                </View>
            </View>
